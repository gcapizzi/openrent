...
use geo::{BoundingRect, Contains, Distance, Geometry, GeometryCollection};
...
impl Area {
    pub fn from_kml(string: String) -> Result<Area> {
        ...
        Area::from_kml_reader(&mut kml_reader)
    }
    ...
    fn from_kml_reader<B: std::io::BufRead>(
        ...
        let collection = GeometryCollection::try_from(kml_data)?;
    ...
    pub fn radius(&self) -> u32 {
        ...
        (Haversine::distance(center, max) / 1000.0).round() as u32
    }
